...
namespace Teknoo\DI\SymfonyBridge\Extension;

use Teknoo\DI\SymfonyBridge\Container\BridgeBuilderInterface;

/**
 * Contract to implement to create an extension able to complete the PHP DI Configuration after reading the Symfony App
 * configuration, without alter or complete the application's files of configurations.
 *
 * @copyright   Copyright (c) EIRL Richard Déloge (https://deloge.io - richard@deloge.io)
 * @copyright   Copyright (c) SASU Teknoo Software (https://teknoo.software - contact@teknoo.software)
 * @license     https://teknoo.software/license/mit         MIT License
